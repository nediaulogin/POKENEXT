...
export default function Card({ pokemon }: any) {
    return (<div className="flex justify-end items-center flex-col bg-gray-800 
        p-7 h-80 rounded-xl border-solid border-4 
        border-purple-800 shadow-1 max-h-30">
        ...
        <h3 className="font-bold my-2 text-white 
                    text-2xl capitalize"> {pokemon.name}</h3>
